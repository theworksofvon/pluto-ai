...
class TwitterPostParams(BaseModel):
    message: str = Field(..., description="The message to post on Twitter", max_length=280)
    media_url: Optional[str] = Field(None, description="Optional URL to media to attach to the tweet")

class TwitterTool(BaseTool):
    def __init__(self, name: str, description: str, api_key: str, api_secret: str, 
    ...
    async def execute(self, message: str, media_url: Optional[str] = None) -> ToolResult:
        """
